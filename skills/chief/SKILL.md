...
1. Own the forge before delegating: run `chief_forge_init` and its script for the issue, task branch, and draft pull request. See **Git workflow** below, then delegate.
